...
part of 'realm_card_dto.dart';

// **************************************************************************
// RealmObjectGenerator
// **************************************************************************

class RealmCardDTO extends $RealmCardDTO with RealmEntity, RealmObject {
  RealmCardDTO({
    String? cardId,
    String? dbfId,
    String? name,
  ...
  @override
  Stream<RealmObjectChanges<RealmCardDTO>> get changes =>
      RealmObject.getChanges<RealmCardDTO>(this);

  static SchemaObject get schema => _schema ??= _initSchema();
  static SchemaObject? _schema;
  static SchemaObject _initSchema() {
    RealmObject.registerFactory(RealmCardDTO._);
    return const SchemaObject(RealmCardDTO, 'RealmCardDTO', [
