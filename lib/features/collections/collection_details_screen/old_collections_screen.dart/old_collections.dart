...
class OldCollections extends StatefulWidget {
  ...
  @override
  State<OldCollections> createState() => _OldCollectionsState();
}

class _OldCollectionsState extends State<OldCollections> {
  String title = '';
